...
const HomePage = ({ daftarSyarat = [] }) => { // Default value as an empty array
  ...
  return (
    <div>
      ...
      <div className="main">
        <h1 className="text-3xl text-center font-semibold">Visi dan Misi PTSP</h1>
        <div className="additional-content mt-5 text-center">
          <p className="text-black  font-family-poppins text-start ">
            Visi dan Misi dari sistem Pelayanan Terpadu Satu Pintu (PTSP) adalah sebagai berikut :
          </p>
