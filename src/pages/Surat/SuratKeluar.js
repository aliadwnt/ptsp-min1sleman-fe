...
const SuratKeluar = ({
    ...
    useEffect(() => {
        document.title = `PTSP MAN 1 YOGYAKARTA - Surat Keluar`; //   'APP NAME' dengan nama aplikasi Anda
    }, []);
    ...
    const handleDelete = (id) => {
        if (window.confirm('Yakin mau di hapus?')) {
            ...
            // Misalnya, memanggil fungsi untuk menghapus item dari state di komponen induk
        }
    };
