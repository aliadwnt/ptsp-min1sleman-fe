        ...
        <div className="flex">
            ...
            <div className="flex-1">
                ...
                <div className='bodyadmin'>
                    <div className="texttitle">Surat Keluar</div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead className="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ditujukan Kepada</th>
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Isi Ringkas</th>
                                            ...
                                            {dataPelayanan.length > 0 ? (
                                                dataPelayanan.map((item, index) => (
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.nomor_surat}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.ditujukan_kepada}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.isi_ringkas}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">
                                                            <a href={item.download_link} className="text-blue-600 hover:text-blue-500" download>
                                                                Download
                                                            </a>
                                                        </td>
