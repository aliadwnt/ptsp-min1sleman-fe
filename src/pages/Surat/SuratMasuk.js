                                            ...
                                            {dataPelayanan.length > 0 ? (
                                                dataPelayanan.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.no_agenda}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.no_surat}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.pengirim}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.penerima}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.disposisi}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.surat}</td>
                                                        <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.lampiran}</td>
                                                ...
                                                <tr>
                                                    <td colSpan="9" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">No data available</td>
                                                </tr>
                                            )}
                                        </tbody>
                                    </table>
