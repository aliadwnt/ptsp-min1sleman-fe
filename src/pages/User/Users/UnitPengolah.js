                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead className="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Unit Pengolah</th>
                                            ...
                                            {dataPelayanan.length > 0 ? (
                                                dataPelayanan.map((item, index) => (
                                                    <tr key={item.id}> {/* Use item.id as the key */}
                                                        ...
                                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-400">{item.nama_unit_pengolah}</td>
