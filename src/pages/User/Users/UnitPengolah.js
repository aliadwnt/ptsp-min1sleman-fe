                  ...
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-800">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Unit Pengolah</th>
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg shadow-lg p-6 w-50">
                ...
                <form onSubmit={handleSubmit}>
                  <input type="text" name="id" defaultValue={currentUnitPengolah?.id || ""} placeholder="id" required className="block w-full p-2 border border-gray-300 rounded mb-4" />
