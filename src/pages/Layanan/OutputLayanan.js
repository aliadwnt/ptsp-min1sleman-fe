          ...
          <div className="flex items-center justify-between space-x-2 mb-4">
            <form onSubmit={handleSearch} className="flex flex-grow">
              <input
                ...
                className="block w-full p-3 pl-8 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Search..."
                required
              />
              <button
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 w-50">
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex justify-end col-span-2 space-x-2">
                  ...
                  <button type="submit" className="bg-green-600 text-white px-4 py-2 rounded">{currentOutputLayanan ? "Update" : "Tambah"}</button>
                </div>
              </form>
            </div>
          </div>
