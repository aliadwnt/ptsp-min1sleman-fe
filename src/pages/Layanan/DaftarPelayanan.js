...
<div className="flex items-center justify-center space-x-2 mb-4">
  <form onSubmit={handleSearch} className="flex flex-grow justify-center">
    ...
    />
          ...
          <li className="mb-2 me-16 relative group" role="presentation"> 
        <button
          className={`inline-block p-2 border-b-3 w-20 rounded-t-lg ${activeTab === 'all' ? 'border-green-900 text-black-600' : ''}`}
          id="all-tab"
  ...
  <li className="mb-8 me-16 relative group" role="presentation"> 
          <button
                    className={`inline-block p-2 border-b-3 w-20 rounded-t-lg ${activeTab === 'all' ? 'border-green-900 text-black-600' : ''}`}
            id="accept-tab"
        ...
        <li className="mb-20 me-16 relative group" role="presentation">
          <button
                      className={`inline-block p-2 border-b-3 w-20 rounded-t-lg ${activeTab === 'all' ? 'border-green-900 text-black-600' : ''}`}
            id="verify-tab"
  ...
  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
    <thead className="bg-gray-50 dark:bg-gray-800">
      <tr>
        ...
        <th className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Kelengkapan</th>
        <th className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Status</th>
      ...
      {dataDaftarPelayanan.length > 0 ? (
        dataDaftarPelayanan.map((item, index) => (
          <tr key={item.id}>
            ...
            <td className="px-3 py-3 text-xs text-center text-gray-900 dark:text-gray-400 hidden md:table-cell">{item.kelengkapan}</td>
            ...
            <td className="text-center">
              <div className="flex justify-center space-x-2">
                <button
                  onClick={() => navigate(`/layanan/daftar-pelayanan/show-disposisi/${item.id}`)}
        ...
        <tr>
          <td colSpan="7" className="text-center py-3 text-gray-500">Data tidak ditemukan</td>
        </tr>
      )}
    </tbody>
  </table>
