                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead className="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Durasi Layanan</th>
                                                ...
                                                dataPelayanan.map((item, index) => {
                                                    ...
                                                    return (
                                                        <tr key={item.id}> {/* Use item.id as the key */}
                                                            ...
                                                            <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.unit_pengolah}</td>
                                                            <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.nama_layanan}</td>
                                                            <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.jenis_layanan}</td>
                                                            <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-400">{item.output_layanan}</td>
