...
const SyaratLayanan = ({
    ...
    useEffect(() => {
        document.title = `PTSP MAN 1 YOGYAKARTA - Jenis Layanan`; //   'APP NAME' dengan nama aplikasi Anda
    }, []);
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        {dataPelayanan.length > 0 ? (
                                            ...
                                            <tr>
                                                <td colSpan="7" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-widerr">No data available</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
