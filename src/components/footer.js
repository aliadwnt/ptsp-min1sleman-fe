    ...
    <footer className="select-none font-family bg-green-700 text-white py-12 mt-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          {/* Useful Links */}
          <div className="flex flex-col items-center sm:items-start">
            <h6 className="font-bold text-lg text-white mt-10 mb-4">
              LINK TERKAIT
            </h6>
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="https://min1sleman.sch.id/gtk/"
                  className="hover:text-green-900"
                >
                  Guru dan Staff
                </Link>
      ...
      <div className="mt-3 bg-green-800 py-4 text-center text-white">
        <p>
          ...
          <span className="p-2 font-semibold">MIN 1 SLEMAN</span> All Rights
          Reserved
        </p>
      </div>
    </footer>
